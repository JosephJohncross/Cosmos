...
import ClientProviderWrapper from '../pages/client/client-provider';
...
export const CustomRoutes = () => {
  return [
    <Route>
      ...
      <Route
        element={<FreeLancerProviderWrapper />}
        path={ApplicationRoutes.FREELANCER_DASHBOARD}
      ></Route>
      <Route
        element={<FreeLancerSetupSteps />}
        path={ApplicationRoutes.FREELANCER_SETUP}
      ></Route>
      <Route
        element={<ClientProviderWrapper />}
        path={ApplicationRoutes.CLIENT_DASHBOARD}
      ></Route>
      <Route
        element={<ApplyForJobPage />}
        path={ApplicationRoutes.JOB_APPLY}
      ></Route>
      <Route
        element={<PostAJobSteps />}
        path={ApplicationRoutes.POST_A_JOB}
      ></Route>
      <Route
        element={<ProposalPage />}
        path={ApplicationRoutes.PROPOSAL}
      ></Route>
    </Route>,
  ];
};
