...
const ActiveHireJob = ({acceptPayModal, terminateContract}: ActiveHireJobProps) => {
    return (
        <>
            <div className="">
                        ...
                        <div className="flex items-center justify-between space-x-3 flex-wrap mt-1 font-circular">
                            <div className="flex items-center space-x-2">
                                ...
                                <div className="flex items-center space-x-1">
                                    <svg className="scale-90" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex items-center space-x-5 font-circular text-sm mt-4">
                    ...
                    <Button onClick={() => {acceptPayModal.current.click()}} className="w-1/2 bg-[#D4FFE7] hover:bg-[#D4FFE7] rounded-full focus:bg-[#F4F4F5] text-[#7E8082] border-[#8EFFBE] border">Pay now</Button>
                </div>
            </div>
        </>
    )
