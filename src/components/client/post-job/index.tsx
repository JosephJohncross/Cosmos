...
import {
  PostJobStepperFormKeysType,
  PostJobStepperFormValues,
} from '../../../hooks/post-job-stepper';
...
const PostAJobSteps = () => {
  ...
  const getStepContent = (step: number) => {
    switch (step) {
      ...
      case 3:
        return (
          <DescriptionSection handleBack={handleBack} handleNext={handleNext} />
        );
      case 4:
        return (
          <BudgetSection handleBack={handleBack} handleNext={handleNext} />
        );
      case 5:
        return (
          <TimelineSection handleBack={handleBack} handleNext={handleNext} />
        );
      case 6:
        return (
          <PublishSection
