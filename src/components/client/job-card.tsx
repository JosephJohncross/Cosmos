...
export type PostJobCardComponentProps = {
  ...
  onSelectForPayment?: (job: any) => void;
};
      ...
      >
        <div className='flex justify-between'>
          ...
          <div className='flex items-center space-x-4'>
            ...
            >
              ...
              />
              <path
                d='M29.5 15.5L28.8803 25.5251C28.7219 28.0864 28.6428 29.3671 28.0008 30.2879C27.6833 30.7431 27.2747 31.1273 26.8007 31.416C25.8421 32 24.559 32 21.9927 32C19.4231 32 18.1383 32 17.179 31.4149C16.7048 31.1257 16.296 30.7408 15.9787 30.2848C15.3369 29.3626 15.2594 28.0801 15.1046 25.5152L14.5 15.5'
                stroke='#EA3A5A'
                stroke-width='1.5'
              ...
              />
              <path
                d='M20.5 25.6543H23.5'
                stroke='#EA3A5A'
                stroke-width='1.5'
                stroke-linecap='round'
              />
              <path
                d='M13 15.5H31M26.0555 15.5L25.3729 14.0917C24.9194 13.1563 24.6926 12.6885 24.3015 12.3968C24.2148 12.3321 24.1229 12.2745 24.0268 12.2247C23.5937 12 23.0739 12 22.0343 12C20.9686 12 20.4358 12 19.9955 12.2341C19.8979 12.286 19.8048 12.3459 19.7171 12.4132C19.3215 12.7167 19.1004 13.2015 18.6584 14.1713L18.0527 15.5'
                stroke='#EA3A5A'
                stroke-width='1.5'
                stroke-linecap='round'
              />
        ...
        {freelancer_address && (
          <div className='mt-3 text-sm text-gray-500'>
            <p>
              Assigned to: {freelancer_address.slice(0, 8)}...
              {freelancer_address.slice(-6)}
            </p>
          </div>
        )}
      </div>
