...
export const MultiSelector = ({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 w-full p-2 border min-h-12 rounded-md">
      {selected.map((item) => (
        <div
          key={item}
      ...
      {selected.length < maxSelections && (
        <input
          ...
          className="flex-1 min-w-[50px] outline-none bg-transparent px-4 rounded-md"
