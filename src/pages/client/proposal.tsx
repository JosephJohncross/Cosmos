...
import CopyIcon from "../../components/icons/client/copy-icon"
        ...
        <>
            <main className="mt-32 px-5 mb-36">
                <div className="max-w-screen-lg mx-auto w-full">
                    <div className="bg-white relative rounded-xl p-10 mt-9 pb-32 font-circular ">
                        <Link to={ApplicationRoutes.CLIENT_DASHBOARD} className="">
                            <LucideMoveLeft size={20}/>
                        </Link>

                        <div className="flex mt-6 gap-x-9">
                            <div className="w-3/5">
                                <h2 className="font-poppins text-[24px] text-[#18181B] font-semibold">Project Proposal Form</h2>
                                <p className="text-[#7E8082] font-circular text-base">Below are the contact details of the freelancer who has submitted a proposal for your project role.</p>
                            
                                <div className="mt-12 font-circular">
                                    <p className="text-[#545756] font-medium text-lg">Message for you:</p>

                                    <p className="text-[#545756] text-base font-normal mt-4">I’m Onesty, a UX/UI designer with 4 years of experience in product design field. I came across your job opening for UIUX role and would love to bring my skills in branding, user interfaces, user experience and prototyping to you.
                                        Here’s what I offer:
                                        Boosted engagement by 30% through a redesigned website.
                                        I turn complex ideas into visually stunning, user-friendly designs.
                                        I work closely with teams to align designs with business goals.
                                        I’d love to discuss how I can contribute to your team. You can view my work here: https://behance.net/onlyhonesst. Let me know a good time to connect!
                                ...
                                <div className="flex flex-col gap-y-4 mt-10">
                                    <div className="">
                                        <p className="text-[#545756] pb-3 font-medium">Freelancer’s Email</p>
                                    ...
                                    <div className="">
                                        <p className="text-[#545756] pb-3 font-medium">Freelancer’s Phone</p>
                                        <div className="border-[#E4E4E7] flex items-center justify-between rounded-md py-3 text-[#545756] px-5 border">
                            ...
                            <div className="w-2/5 font-circular">
                                <div className="bg-[#F4F4F5] border border-[#E4E4E7] rounded-md px-5 py-6">
                                    ...
                                    <div className="py-5">
                                        <p className="text-[#545756] text-[15px]">UIUX Designer, Illustrator, Motion & Brand Designer</p>
                                ...
                                <div className="mt-7 flex flex-col gap-y-2">
                                    <Button onClick={() => {hireModal.current.click()}} className="text-white w-full">Hire freelancer</Button>
                                    <Button onClick={() => {rejectModal.current.click()}} className="text-[#FB822F] hover:bg-white focus:bg-white border border-[#FB822F] bg-white w-full">Reject freelancer</Button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <Dialog >
                <DialogTrigger asChild>
                    <div ref={hireModal} className="hidden">Edit Profile</div>
                </DialogTrigger>

                <DialogContent className="sm:max-w-[425px] bg-white">
                    <div className="flex flex-col items-center">
                        <p className="text-[20px] mb-6 font-poppins font-semibold text-[#18181B] mt-5">Hire Onest Man</p>
                        ...
                        <div className=" flex justify-center">
                            <span className="text-[#7E8082] font-normal font-circular text-sm text-center mt-5">You’re about to hire Onest Man. 
                            Once confirmed, they’ll be notified and granted project access.</span>
                        </div>
                    </div>
                    ...
                    <div className="mb-3 flex space-x-3">
                        ...
                        <Button className="w-full mt-6 bg-primary text-white">Confirm hire</Button>
                    </div>
                </DialogContent>
            </Dialog>
            ...
            <Dialog >
                <DialogTrigger asChild>
                    <div ref={rejectModal} className="hidden">Edit Profile</div>
                </DialogTrigger>

                <DialogContent className="sm:max-w-[425px] bg-white">
                    <div className="flex flex-col items-center">
                        <p className="text-[20px] mb-6 font-poppins font-semibold text-[#18181B] mt-5">Reject Proposal</p>
                        ...
                        <div className=" flex justify-center">
                            <span className="text-[#7E8082] font-normal font-circular text-sm text-center mt-5">Are you sure you want to reject Onest Man’s proposal? 
                    ...
                    <div className="mb-3 flex space-x-3">
                        ...
                        <Button className="w-full mt-6 bg-[#FB822F] text-white hover:bg-[#FB822F] focus:bg-[#FB822F]">Reject proposal</Button>
                    </div>
                </DialogContent>
            </Dialog>
        </>
