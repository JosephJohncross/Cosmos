...
// Form schema for the job application
...
const ApplyForJobPage = () => {
  ...
  const { rawJobs: jobs, isLoading: loadingJobs } = useJobContract();
  ...
  const onSubmit = async (data: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      // Prepare the proposal data for the contract
      const proposal = {
        submit_proposal: {
          job_id: parseInt(jobId),
          bid_amount: data.bidAmount, // Contract expects string for Uint128
