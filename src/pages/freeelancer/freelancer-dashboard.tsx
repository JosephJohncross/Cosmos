...
import ProjectListingComponent, { ProjectListingComponentProps, ProjectListingComponentType } from "../../components/freelancer/project-listing-component"
        ...
        <>
            ...
            <Sheet>
                ...
                <SheetContent side="bottom" className="h-[90vh] custom-scrollbar max-w-screen-lg  mx-auto rounded-2xl mb-10 bg-white font-circular">
                    <SheetHeader>
                        <SheetDescription className="hidden">Job description</SheetDescription>
                    </SheetHeader>
                    ...
                    <div className="w-full px-5">
                        ...
                        <div className="font-circular h-[70vh] overflow-auto custom-scrollbar">
                            <p className="mt-3 font-medium text-lg text-[#18181B]">Web Designer - UIUX</p>

                            <p className="text-base mt-5 font-normal text-[#545756]">We are seeking new freelancers for a UI/UX project focused on a sports niche website. The project involves designing four pages, including a homepage, with a minimalistic design approach. Candidates should be able to deliver rapid work while maintaining high-quality standards. If you are passionate about user experience and can create visually appealing interfaces, we want to hear from you!</p>
                            ...
                            <div className="border-t border-gray-200 mt-7 flex divide-x divide-gray-200 pt-5">
                                <div className="w-1/2">
                                    ...
                                    <p className="text-[#7E8082] font-normal text-base mt-1">UIUX Designer</p>

                                    <p className="text-[#545756] font-normal text-base mt-5">Expertise</p>

                                    <div className="flex items-center space-x-3 mt-2">
                                        <div className="border-[#E4E4E7] border bg-[#F4F4F5] text-[#545756] font-normal rounded-full text-sm py-1 px-3">Product Design</div>
                                        <div className="border-[#E4E4E7] border bg-[#F4F4F5] text-[#545756] font-normal rounded-full text-sm py-1 px-3">Branding</div>
                                        <div className="border-[#E4E4E7] border bg-[#F4F4F5] text-[#545756] font-normal rounded-full text-sm py-1 px-3">User Research</div>
                                    </div>
                                </div>
                            ...
                            <div className="border-t border-gray-200 mt-7 flex divide-x divide-gray-200 pt-5 pb-10">
                                <div className="w-1/2">
                                    <p className="font-medium text-base text-[#18181B]">Job Activity Updates</p>
